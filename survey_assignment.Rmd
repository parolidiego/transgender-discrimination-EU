...
The stepwise regression gives us the following as the best model: 

    trans_docs = age + gender + marital_status + occupation + 
...
It might not be the best with factors, but it could be useful with numeric
...
complete_df <- complete_df |> 
  drop_na() # should only be in our target
...
# Need to calculate intra class coefficient (proportion of variation explained by the grouping level)
