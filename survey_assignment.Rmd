...
I thought by aggregating we meant synthesizing the information from the individual respondents into country-level variables? but I don't know if this is something that models do directly.
...
The next variables are not numeric nor factor with 2 levels, so they are not included in data_aggr:
```{r}
