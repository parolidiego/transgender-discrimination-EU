...
Next I should be aggregating some of the discriminatory questions

Until `qc6` dataset should be clean. Start from there and try to aggregate responses from qc6, qc12 and qc13
...
_Useful package for visualising and interpreting linear mixed models:_ 
